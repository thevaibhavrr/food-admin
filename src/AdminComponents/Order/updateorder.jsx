...
//       return ["manager", "delivryboy"].includes(user.role.toLowerCase()); // Manager sees managers and deliveryboys
//     }
//     if (user.role.toLowerCase() === "delivryboy") {
//       return user.role.toLowerCase() === "delivryboy"; // Deliveryboy sees only deliveryboys
//     }
//     return false;
//   });
...
const UpdateOrderPopup = ({ orderId, onClose }) => {
  ...
  const filteredUsers = users.filter((user) => user.role.toLowerCase() === "deliveryboy");
